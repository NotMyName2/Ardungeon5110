...
uint8_t pcd8544_buffer[(LCDWIDTH+1)* LCDHEIGHT / 8] = {
...
void Adafruit_PCD8544::GotoXYonDisplay(int x, int y) {

  command( 0x80 | x);  // Column.
  command( 0x40 | y);  // Row.
...
void Adafruit_PCD8544::clearDisplayKeepRam(void) {
